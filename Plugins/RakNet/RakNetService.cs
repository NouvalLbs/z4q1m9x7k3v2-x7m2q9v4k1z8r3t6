...
namespace ProjectSMP.Plugins.RakNet
{
    ...
    public class PacketEventArgs : EventArgs
    {
        ...
        public BitStream BitStream { get; set; } = null!;
    ...
    public static class RakNetService
    {
        ...
        /// <summary>
        /// Emulate an incoming packet from a player
        /// </summary>
        ...
        /// <summary>
        /// Emulate an incoming RPC from a player
        /// </summary>
        ...
        /// <summary>
        /// Get temporary BitStream for a player (managed by Pawn bridge)
        /// </summary>
        ...
        internal static int HandleIncomingPacket(int playerId, int packetId, int bsHandle)
        {
            ...
            {
                Console.WriteLine($"[RakNet] Error in HandleIncomingPacket: {ex.Message}");
                return 1; // Don't block on error
            }
        }
        ...
        internal static int HandleOutgoingPacket(int playerId, int packetId, int bsHandle)
        {
            ...
            {
                Console.WriteLine($"[RakNet] Error in HandleOutgoingPacket: {ex.Message}");
                return 1; // Don't block on error
            }
        }
        ...
        internal static int HandleIncomingRPC(int playerId, int rpcId, int bsHandle)
        {
            ...
            {
                Console.WriteLine($"[RakNet] Error in HandleIncomingRPC: {ex.Message}");
                return 1; // Don't block on error
            }
        }
        ...
        internal static int HandleOutgoingRPC(int playerId, int rpcId, int bsHandle)
        {
            ...
            {
                Console.WriteLine($"[RakNet] Error in HandleOutgoingRPC: {ex.Message}");
                return 1; // Don't block on error
            }
        }
    }
